...
import type { CustomerProfile } from "@/lib/services/customer.service"
...
const customerFormSchema = z.object({
  ...
  kycStatus: z.enum(["verified", "pending", "rejected"] as const),
  ...
  const onSubmit: SubmitHandler<CustomerFormValues> = async (data) => {
    ...
    try {
      await customerService.createCustomer({
        ...
        annualIncome: data.annualIncome ? parseFloat(data.annualIncome.replace(/[^0-9.-]+/g, '')) : undefined,
      })
      toast({
            ...
            <TabsContent value="personal">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Enter the customer's basic personal information.</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="contact">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Enter the customer's contact information and address.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <FormField
            ...
            <TabsContent value="financial">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Enter the customer's financial details for KYC and compliance.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <FormField
                    control={form.control}

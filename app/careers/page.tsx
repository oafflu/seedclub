          ...
          <div className="bg-primary/10 p-8 rounded-xl mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              <div className="flex flex-col items-center text-center p-4">
                <div className="rounded-full bg-primary/20 p-3 sm:p-4 mb-3 sm:mb-4">
                  <HeartHandshake className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
                </div>
                <h3 className="font-bold mb-1 sm:mb-2">Meaningful Work</h3>
              ...
              <div className="flex flex-col items-center text-center p-4">
                ...
                <h3 className="font-bold mb-1 sm:mb-2">Remote-First</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
              ...
              <div className="flex flex-col items-center text-center p-4">
                ...
                <h3 className="font-bold mb-1 sm:mb-2">Growth Opportunities</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="bg-muted/30 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Health & Wellness</h3>
            ...
            <div className="bg-muted/30 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Financial Benefits</h3>
              <ul className="space-y-1 sm:space-y-2 text-muted-foreground text-sm">
            ...
            <div className="bg-muted/30 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Work-Life Balance</h3>
              <ul className="space-y-1 sm:space-y-2 text-muted-foreground text-sm">
            ...
            <div className="bg-muted/30 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Growth & Development</h3>
              <ul className="space-y-1 sm:space-y-2 text-muted-foreground text-sm">
